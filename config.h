...
static const struct xkb_rule_names xkb_rules = {
  ...
  .layout = "us, ru",
  .options = "grp:win_space_toggle,ctrl:nocaps,keypad:pointerkeys",
};
...
static const char *cleartermcmd[] = { DWL_CONF_PATH"scripts/clearterminal.sh", NULL };
static const char *attachtermcmd[] = { DWL_CONF_PATH"scripts/attachtermcmd.sh", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_T,          spawn,          {.v = cleartermcmd} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_A,          spawn,          {.v = attachtermcmd} },
	...
	// { MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT,   XKB_KEY_H,      incogaps,      {.i = +1 } },
	// { MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT,   XKB_KEY_L,      incogaps,      {.i = -1 } },
	// { MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_CTRL,    XKB_KEY_h,      incigaps,      {.i = +1 } },
	// { MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_CTRL,    XKB_KEY_l,      incigaps,      {.i = -1 } },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_0,          togglegaps,     {0} },
	{ MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT,   XKB_KEY_parenright,defaultgaps,    {5} },
...
#define VOLUME_CMD "wpctl set-volume @DEFAULT_SINK@ "
#define BRIGHTNESS_CMD "brightnessctl set "

	// { 0,                    XKB_KEY_XF86AudioRaiseVolume,          spawn,          {.v =  termcmd} },
	// { 0,                    XKB_KEY_XF86AudioLowerVolume,          spawn,          {.v =  termcmd} },
	// { 0,                    XKB_KEY_XF86MonBrightnessUp,          spawn,          {.v = termcmd} },
	// { 0,                    XKB_KEY_XF86MonBrightnessDown,          spawn,          {.v =  termcmd} },
...
// 	{ MODKEY,                    XKB_KEY_h,          setmfact,       {.f = -0.05f} },
// 	{ MODKEY,                    XKB_KEY_l,          setmfact,       {.f = +0.05f} },
// 	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_H,          change_height,  {.i = -5} },
// 	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_L,          change_height,  {.i = +5} },
...
// 	TAGKEYS(          XKB_KEY_8, XKB_KEY_asterisk,                   7),
// 	TAGKEYS(          XKB_KEY_9, XKB_KEY_parenleft,                  8),
//   // Hyprland like special workspace
//
// 	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Q,          quit,           {0} },
//
// 	/* Ctrl-Alt-Backspace and Ctrl-Alt-Fx used to be handled by X server */
